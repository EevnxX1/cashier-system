...
export default function UserDropdown() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
      ...
      Swal.fire({
        title: "Kamu Yakin Ingin Logout Dari Akun Ini?",
        text: "Kamu akan akan keluar dari halaman ini, kembali ke halaman login",
        icon: "warning",
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="block mr-1 font-medium text-theme-sm">{name.split(" ")[0]}</span>
